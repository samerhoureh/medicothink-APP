...
class ApiService {
  ...
  Future<ApiResponse<User>> login(String email, String password) async {
    try {
      ...
      return ApiResponse<User>.error(message: 'Network error: $e');
    }
  }
  ...
  Future<ApiResponse<Map<String, dynamic>>> sendOtp(String phoneNumber) async {
    try {
      ...
      return ApiResponse<Map<String, dynamic>>.error(message: 'Network error: $e');
    }
  }
  ...
  Future<ApiResponse<String>> sendChatMessage(String conversationId, String message) async {
    try {
      ...
      return ApiResponse<String>.error(message: 'Network error: $e');
    }
  }
  ...
  Future<ApiResponse<List<Map<String, dynamic>>>> getConversations() async {
    try {
      ...
      return ApiResponse<List<Map<String, dynamic>>>.error(message: 'Network error: $e');
    }
  }
